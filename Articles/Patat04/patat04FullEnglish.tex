...
\title{\bf{The architecture of a system of production of the schedules of course and exams}}
...
{\bf Keywords :} Production of schedules, Construction of
schedules, Open architecture, Extensible Architecture, Data bases,
Web.

\section{Introduction}

The production of schedules is a periodic task carried out in many
institutions of teaching. These institutions produce one or more
schedules per year for the courses and the examinations. The
automation of this production can reduce its cost in an important
way. In certain cases, automation starts with the use of a
software of construction of schedules; in others, it starts with
the automation of the treatments associated with the work of the
institution, as for example followed it students. There are
software to carry out the construction of schedules, by example
DIAMANT \cite{gonzalezrubio00} and SAPHIRE \cite{ferland94}, but,
there exists many others.

In general, the software for the creation of schedules uses as
input one or more files. Their output is recorded on one or more
files. The work with files is a source of problems. It is
necessary to build the input files each time that a schedule is
produced. There exists, two cases~: a manual production of the
files or an automated production. If the files are produced
manually, there are the typing errors that can produce unexpected
effects in the software. The errors are difficult to find, because
...
software is ensured to check the validity and the coherence of all
the data. The second problem appears when a change is introduced
into the system (either in the application of construction, or in
that of the production of files) or if the application of
construction is used in several different sites, using different
data formats.
...
\begin{picture}(19,7)
  ...
  \put (0,6){\line(1,0){22}}
  \put (19,6.5){\makebox(0,0){\scriptsize Interface}}
