%% BEGIN PrÈsentation de  PILE aux Profs
%\title PrÈsentation de  PILE
...
%%%0
\bslide
\bheading A timetable production system architecture 
for courses and 
exams
\eheading
...
DÈpartement de gÈnie Èlectrique \\
et de gÈnie informatique \\
UniversitÈ de Sherbrooke,\\
Sherbrooke, QuÈbec, J1K 2R1 \\
Canada \\
\pro{Ruben.Gonzalez-Rubio@USherbrooke.ca} \\

\pro{http://tictacserv.gel.usherb.ca:9006/}\\
\pro{diamantbug/index.jsp}
...
\begin{itemize}
	...
	\item Timetable Production System Architecture.
	\begin{itemize}
		\item Motivation: Requirements changes in timetabling systems,
		So the Architecture must be: open and extensible.	
		\item The Information Flow in Timetable Production.
		\item Modules and technology.
	\end{itemize}
	\item Conclusions
\end{itemize}
...
\begin{itemize}
 \item Requirements changes in timetabling systems.
 For exemple data formats, new data, etc.
 
\item Build a system following qualities of 
openness and extensibility. 

\item The system reduces the cost of 
...
\item This architecture makes use of a database, a Web site and a software 
for timetable construction. Data checking and validation will be made 
with the input and with integrity constraints in the database. 

\item Another function of the Web site is to offer a personalized 
timetable, once it is built. 
\end{itemize}
...
%%%0
\bslide
\bheading The Information Flow in Timetable Production
\eheading
...
%%%0
\bslide
\bheading Evolution of Data During Timetable
Production
\eheading
...
%\caption{Evolution of Data During Timetable Production}
\label{fig:fTwoS}
\end{figure}
...
%%%0
\bslide
\bheading Data Input and Timetable Construction Activities for
a $P$ Period
\eheading
...
\bslide
\bheading The Three-Layers Architecture
\eheading
...
\begin{picture}(3,4.5)
  \put(0,4){\framebox(4,1){Interface}}
  \put(1.5,3.5){\vector(0,1){0.5}}
  \put(2.5,4){\vector(0,-1){0.5}}
  \put(0,2.5){\framebox(4,1){Business Logic}}
  \put(1.5,2){\vector(0,1){0.5}}
  \put(2.5,2.5){\vector(0,-1){0.5}}
  \put(0,1){\framebox(4,1){Data Persistence}}
\end{picture}
%\caption{The Three-Layers Architecture}
\label{fig:fThreeS}
\end{center}
\end{figure}
...
\bslide
\bheading Implementation of the Three-layers Architecture for
...
\bslide
\bheading To implement the architecture
\eheading
...
%%%0
\bslide
\bheading Possible Instances of 
Architecture
\eheading
...
\hline
\end{tabular}
 %\caption{Possible Instances of Architecture}
\label{tb:tbOneS}
\end{table}
...
%%%0
\bslide
\bheading The Evolution of an Instance of the Architecture
\eheading

\begin{table}[htb]
	\begin{tabular}{|c||c|c|c|}\hline
	Technology & Version 1 & Version 2 & Version 3\\ \hline\hline
	Language  & HTML \& JSP & HTML and PHP & HTML and JSP\\
	for Display & ~         &   ~           &     ~      \\
	\hline
	Format to Data Exchange & Text & XML & Database SQL\\
	\hline
	Language to Code  & Java & Java & Java\\
	the Business Logic & ~         &   ~           &     ~      \\
	\hline
...
%	\caption{The Evolution of an Instance of the Architecture}
\label{tb:tbTwoS}
	\end{table}
...
\bslide
\bheading We presented
\eheading

\begin{itemize}
\item The architecture of a timetable production system in
...
\item We started by showing the needs for information exchange in the
...
with timetable production?'' 

Our experience in software
...
different: for example, for an exam timetable the teachers’ 
...
is provided by the ñWorld
Wide Web Consortiumî\footnote{http:\//\//www.w3.org/}.\\
