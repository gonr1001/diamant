...
nécessaires dans un base de données. Dans le schéma il n'est pas
...
Il nous apparaît clair que  le système doit deux composantes
...
Verification de contraintes (bd) Dans le système que nous
proposons, nous essayons de limiter le plus possible
d'intervention humaine afin de réduire des erreurs de
manipulation. Nous essayons de réduire aussi le sources possible
d'erreurs en vérifiant l'entrée de données.
