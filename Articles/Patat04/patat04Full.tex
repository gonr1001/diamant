...
patat04Full.tex d'horaires. La vérification et la validation de
données  se font à l'entrée de données et en appliquant des
contraintes d'intégrité dans la base de données.  Le site Web est
utilisé principalement pour la saisie de données, ceci permet de
vérifier aussi la validité des données, grâce aux règles
d'affaires avant que la donnée soit entrée dans la base. Une autre
...
facilitée. Bien entendu, avec l'aide du logiciel de construction
