...
responsabilité est de chercher les données nécessaires et de le
placer dans le système de production. À noter que les utilisateurs
du système pour des raisons de sécurité ne doivent pas avoir le
droit de modifier les données de l'institution.
...
surtout dans des pays où parfois il fait $-30^\circ$, cela est
bien apprécié.
