...
possible de considèrer que toutes les données nécessaires ont été
...
plus réaliste est de considèrer que certains données peuvent
...
transféres à la base de données, pour construire les fichiers
