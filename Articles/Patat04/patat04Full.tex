...
\begin{picture}(12,3)
  \put(0,1){\framebox(3.5,1){interface utilisateur}}
  \put(3.5,1.5){\vector(1,0){0.5}}
  \put(4,1){\framebox(3.5,1){logique d'affaires}}
  \put(7.5,1.5){\vector(1,0){0.5}}
  \put(8,1){\framebox(4,1){persistance de données}}
\end{picture}
...
Un langage pour faciliter l'affichage des données vers
l'utilisateur ainsi que pour créer des formulaires pour saisir des
données. Un format qui définit la manière d'établir l'échange des
données avec les autres systèmes. Un langage pour coder la logique
d'affaires. Un outil pour gérer la persistance des données.
