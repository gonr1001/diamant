...
cohérence de toutes les données. Le deuxième problème se manifeste
lorsqu'un changement est introduit dans le système (soit dans
l'application de construction, soit dans celui de la production de
fichiers) ou si l'application de construction est utilisée sur
plusieurs sites différents, utilisant des formats des données
différents.
...
architecture ouverte et extensible ont été respectés pendant nos
travaux. Ceci est présenté dans les sections \ref{sec:data} et
\ref{sec:archi}.
...
instance ouvertes et extensibles. Nous pouvons analyser par couche
...
développer des pages Web avec la qualité de compatibilité. Le
problème n'est pas facile, parce que à l'heure actuel nous avons
plusieurs navigateurs Web, entre autres Internet
Explorer\footnote{ http:\//\//www.microsoft.com},
Netscape\footnote{ http:\//\//www.netscape.com}, Mozilla\footnote{
...
en plus ces outils sont gratuites.
...
Une certaine avantage pour PostgreSQL, il n'y a pas coût
d'utilisation.
