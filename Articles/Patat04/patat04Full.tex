...
web paper suggère aussi un autre standard cette fois avec le
...
White \cite{white00} met en évidence que Web doit être utilisé
...
Nous faisons l'analyse de  Afin de simplifier le texte dans
...
d'horaires est automatisé à différents degrés, par exemple~: elle
...
place connue ou mise en format HTML afin de l'afficher sur le Web.
...
présente un risque modéré, car pour chaque nouveau composant
ajouté au système il est possible de revenir à l'ancien composant,
assurant ainsi la production d'horaires.
...
Cette architecture propose la division du système en trois
couches, chacune avec une fonction bien définit :
