...
base). Depuis long temps, les fichiers sont utilisés pour
d'échanger de l'information entre deux systèmes. C'est pour cette
raison que notre système doit être capable de recevoir et envoyer
des fichiers dans un format compatible entre plusieurs systèmes.
