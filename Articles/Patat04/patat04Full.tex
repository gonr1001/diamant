...
base de données.  Le site Internet est utilisé principalement pour
la saisie de données, ceci permet de vérifier aussi la validité
des données, grace au règles d'affaires avant que la donnée soit
entrée dans la base. Autre fonction du site Internet est d'offrir
les horaires de manière personnalisé, une fois que l'horaire est
