...
Les activités de saisie et de construction peuvent être effectuées
par plusieurs d'utilisateurs. Chacun a un rôle et des privilèges
associés pour pouvoir changer certaines données.
...
<<<<<<< patat04Full.tex
consulter son horaire par le Web (à jour) depuis sa résidence,
surtout dans des pays ou parfois il fait $-30^\circ$ et moins.
=======
