...
public class DXToolsMethods {
   ...
   * Exemple:
   * input of a relative path is: ete04.dia
   * the operation return: c:\developpement\DiaExtreme\DX\data\fgen\ete04.dia
   * where c:\developpement\DiaExtreme\DX\data\fgen\ is the absolute path
   * @param str
   * @return
   */
  public final static String getAbsoluteFileName(String absolutePath, String str){
