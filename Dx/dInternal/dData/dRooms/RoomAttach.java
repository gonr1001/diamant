...
public class RoomAttach  extends AvailabilityAttach {
	...
	public String toWrite(){
		...
		//System.out.println("Room: "+_capacity+" -- "+_caracteristics+_ressourceAvailability.size());//debug
		avail += (String)_ressourceAvailability.get(_ressourceAvailability.size()-1);
		...
		if(_capacity!=roomAttach._capacity)
			...
			if(_function!= roomAttach._function)
				...
				if(!_description.equals(roomAttach._description))
					...
					if (!_ressourceAvailability.equals(roomAttach._ressourceAvailability))
						return false;
					else
