...
//        DxInstructor dxiTemp = new DxInstructor(_uniqueKey++,sName, dxaAva);
...
//        DxInstructor dxiTemp = new DxInstructor(0, sName, null);
...
//        DxInstructor dxiTemp = new DxInstructor(lKey,null, null);
...
import dConstants.DConst;
import dInternal.dData.DxAvailability;
import dInternal.dData.DxSetOfRessource;
...
public class DxSetOfInstructors extends DxSetOfRessource {
