...
public class DLoadData {
     ...
     */
    public SetOfInstructors extractInstructors(SetOfInstructors currentList,
        ...
        if (dotDia) {
            instructorsList = new SetOfInstructors(_dm.getTTStructure()
                    .getNumberOfActiveDays(), _dm.getTTStructure()
                    .getCurrentCycle().getMaxNumberOfPeriodsADay());// 5 jours
            // et 14
            // periods!
        } else {
            instructorsList = new SetOfInstructors(5, 14);// 5 jours et 14
            // periods !
        }
        if (de != null) {
            if (merge)
    ...
    public SetOfStuSites extractStudents(SetOfStuSites currentList,
        ...
        if (de.getContents() != null) {
            ...
            new FatalProblemDlg(
                    "I was in LoadData.extractStudents. preload failed!!!");
            System.exit(52);
        }
        return studentsList;
    }
    ...
    public Vector loadTheTT(String fileName, String currentDir) throws Exception /*!!!NIC!!!*/{
        ...
        if (project.countTokens() == 6) { // 6 !!!!!!!!!!!!!!
            ...
            if (tts.getError().length() == 0) {
                if (!DConst.newInstructors) {
                    SetOfInstructors instructorsList = new SetOfInstructors(tts
    ...
    public DSetOfResources selectiveImport(DSetOfResources currentSetOfResc,
        ...
        if (currentSetOfResc instanceof dInternal.dData.dInstructors.SetOfInstructors) {
            ...
            newSetOfResc = extractInstructors((SetOfInstructors) null, false,
                    false);
