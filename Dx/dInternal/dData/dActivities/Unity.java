...
public class Unity extends DObject{
  ...
  */
  ...
  public boolean addAssignment(String cycle){
    return _setOfAssignments.addResource(new DResource(cycle, new DValue()),1);
  }
  ...
  public boolean addActivityBefore(String activityName){
    return _activitiesBefore.addResource(new DResource(activityName, new DValue()),1);
  }
  ...
  public boolean addActivityAfter(String activityName){
    return _activitiesAfter.addResource(new DResource(activityName, new DValue()),1);
  }
  ...
  public boolean addPreferFunctionRoom(String function){
    return _preferFunctionSetOfRooms.addResource(new DResource(function, new DValue()),1);
  }
