 ...
 * 
 */
public class EditEventDlgTest extends TestCase {
	
	private EditEventDlg _editor;
	
	public EditEventDlgTest(String name) {
		super(name);
	}
	...
	public static Test suite() {
		...
		// the dynamic way :
		return new TestSuite(EditEventDlgTest.class);
	} // end suite
	
	protected void setUp() {
		JDialog parent = new JDialog();
		_editor = new EditEventDlg(parent);
	...
	public void testCreationByJFrame() {
		...
		EditEventDlg editor = new EditEventDlg(parent);
