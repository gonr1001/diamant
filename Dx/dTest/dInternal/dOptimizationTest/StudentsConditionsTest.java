...
//		_dm2.buildSetOfEvents();
	...
	public void test_EventsConflicts() {
		...
		Period period = _dm1.getTTStructure().getCurrentCycle()
				.getNextPeriod(1);
		DxStudentCondtionsToTest testStud = new DxStudentCondtionsToTest(_dm1
				.getConditionsToTest().getConflictsMatrix(), _dm1
	...
	public void test2_EventsConflicts() {
		...
		Period period = _dm2.getTTStructure().getCurrentCycle()
				.getNextPeriod(1);
		DxStudentCondtionsToTest testStud = new DxStudentCondtionsToTest(_dm2
				.getConditionsToTest().getConflictsMatrix(), _dm2
	...
	public void test3_periodVariationEventsPeriods() {
		...
		assertEquals(
				"test3_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				15, per.getBeginHour()[1]);
		assertEquals(
				"test3_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				0, per.getPriority());
	}
	...
	public void test4_periodVariationEventsPeriods() {
		...
		assertEquals(
				...
				9, per.getBeginHour()[0]);
		assertEquals(
				"test4_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				15, per.getBeginHour()[1]);
		assertEquals(
				"test4_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				0, per.getPriority());
	}
	...
	public void test5_periodVariationEventsPeriods() {
		...
		assertEquals(
				"test5_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				30, per.getBeginHour()[1]);
		assertEquals(
				"test5_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				0, per.getPriority());
	}
	...
	public void test6_periodVariationEventsPeriods() {
		...
		assertEquals(
				...
				13, per.getBeginHour()[0]);
		assertEquals(
				"test6_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				30, per.getBeginHour()[1]);
		assertEquals(
				"test6_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				0, per.getPriority());
	}
	...
	public void test7_periodVariationEventsPeriods() {
		...
		assertEquals(
				"test7_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				00, per.getBeginHour()[1]);
		assertEquals(
				"test7_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				1, per.getPriority());
	}
	...
	public void test8_periodVariationEventsPeriods() {
		...
		assertEquals(
				...
				20, per.getBeginHour()[0]);
		assertEquals(
				"test8_2_periodVariationEventsPeriods  : assertEquals 2(Minute):",
				00, per.getBeginHour()[1]);
		assertEquals(
				"test8_3_periodVariationEventsPeriods  : assertEquals 3(priotity):",
				1, per.getPriority());
	}

} // end StudentsConditionsTest