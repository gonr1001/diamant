/**
 * 
 * Title: ConditionsTest $Revision: 1.11 $ $Date: 2005-03-08 16:00:45 $
...
public class ConditionsTest extends TestCase {
    ...
    public ConditionsTest(String name) {
        super(name);
        _dm = new DModel(new DDocument(), "." + File.separator + "dataTest" + File.separator
                + "loadData.dia", 1);
    ...
    public void test_getConflictsEventInTTs() {
        ...
        int[] nbConf = _dm.getConditionsTest().getEventConflictsInTTs(_dm.getTTStructure(), event,
            true);
