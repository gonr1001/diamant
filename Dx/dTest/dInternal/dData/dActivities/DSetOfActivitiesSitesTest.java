	 ...
	 public DSetOfActivitiesSitesTest(String name) {
	  ...
	  /**
	   ...
	   public void test_buildSetOfResources1_5(){
	     ...
	     assertEquals("test0_buildSetOfResources1_5: assertEquals 0", 1,setOfsites.size());
	     DResource siteResc = setOfsites.getResource("SHE");
	     assertEquals("test1_buildSetOfResources1_5: assertEquals 1", 1,siteResc.getKey());
	     DResource activityResc = ((SetOfActivities)siteResc.getAttach()).getResource("ADM111");
	     assertEquals("test1_buildSetOfResources1_5: assertEquals 1", 1,activityResc.getKey());
	     assertEquals("test2_buildSetOfResources1_5: assertEquals 2", 2,((Activity)activityResc.getAttach()).getSetOfTypes().size());
	     DResource typeResc = ((Activity)activityResc.getAttach()).getSetOfTypes().getResource("1");
	     assertEquals("test_buildSetOfResources1_5: assertEquals 3", 2,((Type)typeResc.getAttach()).getSetOfSections().size());
	  }
	   ...
	   public void test_buildSetOfResources1_6(){
	     ...
	     assertEquals("test0_buildSetOfResources1_6: assertEquals 0", 1,setOfsites.size());
	     DResource siteResc = setOfsites.getResource("SHE");
	     assertEquals("test1_buildSetOfResources1_6: assertEquals 1", 1,siteResc.getKey());
	     DResource activityResc = ((SetOfActivities)siteResc.getAttach()).getResource("ADM111");
	     assertEquals("test1_buildSetOfResources1_6: assertEquals 1", 1,activityResc.getKey());
	     assertEquals("test2_buildSetOfResources1_6: assertEquals 2", 2,((Activity)activityResc.getAttach()).getSetOfTypes().size());
	     DResource typeResc = ((Activity)activityResc.getAttach()).getSetOfTypes().getResource("1");
	     assertEquals("test_buildSetOfResources1_6: assertEquals 3", 2,((Type)typeResc.getAttach()).getSetOfSections().size());
	  }
