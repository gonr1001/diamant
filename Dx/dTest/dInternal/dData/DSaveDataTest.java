	...
	*/
	...
	import junit.framework.TestSuite;
	  ...
	  public void test2_saveTimeTable(){
	  	assertEquals("test2_saveTimeTable: assertEquals ",true,_dm1.getTTStructure().isEquals(_dm2.getTTStructure()));
	  }
	  /**
	   * test that check that the saved file is the same as the loaded file
	   * */
	  public void test_loadInstructors(){
	  	assertEquals("test3_saveTimeTable: assertEquals ",true,_dm1.getSetOfInstructors().isEquals(_dm2.getSetOfInstructors()));
	  }
	  /**
	   * test that check that the saved file is the same as the loaded file
	   * */
