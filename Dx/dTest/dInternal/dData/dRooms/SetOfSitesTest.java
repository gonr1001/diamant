///**
// *
// * Title: SetOfSitesTest $Revision $  $Date: 2007-07-24 14:04:47 $
...
//		SetOfSites setOfSites = new SetOfSites();
//
//		boolean analyse = setOfSites.analyseTokens(ld
//				.buildDataExchange(dataloaded), 0);
...
//		SetOfCategories soc = (SetOfCategories) setOfSites.getResourceAt(0)
//				.getAttach();
...
//		setOfSites.analyseTokens(ld.buildDataExchange(dataloaded), 0);
//		setOfSites.buildSetOfResources(ld.buildDataExchange(dataloaded), 0);
//		SetOfCategories setOfCat = (SetOfCategories) setOfSites.getResourceAt(
//				setOfSites.size() - 1).getAttach();
...
//		SetOfCategories setOfCat = (SetOfCategories) setOfSites.getResourceAt(
//				setOfSites.size() - 1).getAttach();
//		SetOfRooms setOfRooms = (SetOfRooms) setOfCat.getResourceAt(0)
//				.getAttach();
