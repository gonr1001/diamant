...
public class SetOfStuSitesTest  extends TestCase{
  ...
  public void test_analyseTokens1_5(){
    ...
    assertEquals("test_analyseTokens1_5: assertEquals", DConst.STUD_TEXT6,
    		setOfStuSites.getError().substring(0,DConst.STUD_TEXT6.length()));
  }
  ...
  public void test1_analyseTokens1_5(){
    ...
    assertEquals("test1_analyseTokens1_5: assertEquals", DConst.STUD_TEXT2,
    		setOfStuSites.getError().substring(0,DConst.STUD_TEXT2.length()));
  }
  ...
  assertEquals("test4_analyseTokens1_6: assertEquals", DConst.STUD_TEXT1,
        setOfStuSites.getError().substring(0,DConst.STUD_TEXT1.length()));
  }
  ...
  assertEquals("test6_analyseTokens1_6: assertEquals", DConst.STUD_TEXT3,
        setOfStuSites.getError().substring(0,DConst.STUD_TEXT3.length()));
  }
  ...
  assertEquals("test9_analyseTokens1_6: assertEquals", DConst.STUD_TEXT9,
        setOfStuSites.getError().substring(0,DConst.STUD_TEXT9.length()));
  }
  ...
  public void test2_analyseTokens1_5(){
    ...
    assertEquals("test2_analyseTokens1_5: assertEquals", DConst.STUD_TEXT7,
                 setOfStuSites.getError().substring(0,DConst.STUD_TEXT7.length()));
  }
  ...
  /**
   * test1_buildSetOfResources1_6, test that build the student
   * structure from the student file
   * */
  ...
  DLoadData ld = new DLoadData();
  setOfStuSites.analyseTokens(ld.buildDataExchange(tokens.getBytes()),0);
  setOfStuSites.buildSetOfResources(ld.buildDataExchange(tokens.getBytes()),0);
  SetOfStudents sos= (SetOfStudents) setOfStuSites.getResource("LON")
	.getAttach();
  assertEquals("test1_buildSetOfResources1_6: assertEquals", list,
		sos.getStudentsByGroup("MQB144","1",1));
  }
  ...
  public void test_getStudentsByGroup(){
    ...
    SetOfStudents sos= (SetOfStudents) setOfStuSites.getResource(DConst.STUDENT_STANDARD_SITE)
	.getAttach();
    assertEquals("test_getStudentsByGroup: assertEquals", list,
    		sos.getStudentsByGroup("GEI442","1",1));
  }
