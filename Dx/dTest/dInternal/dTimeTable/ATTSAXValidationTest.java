...
public class ATTSAXValidationTest extends TestCase {
	...
	public void testValidation() {
		...
		assertTrue(ATTSAXValidation.validXMLWithSAX(_path + "ASAXDXTimeTableTest.xml",  "ASAXSchemaTest.xsd"));
		System.out.println("Test de validation d'un fichier XML avec un fichier de schema XSD");
		System.out.println(ATTSAXValidation.validXMLWithSAX(_path + "ASAXDXTimeTableTest.xml", "ASAXSchemaTest.xsd"));
