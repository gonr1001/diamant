/**
 *
 * Title: SaveAsTxtDlg $Revision: 1.14 $  $Date: 2007-03-16 22:16:18 $
 *
 *
...
public class SaveAsTxtDlg extends SaveAsDlg {
	...
	public void addInNewFile(String currentFile) {// , String data) {
		try {
			...
			new DxExceptionDlg("In SaveAsTxtDlg.inNewFile: "
					+ fnfe.getMessage(), fnfe);
		} catch (ObjectStreamException ose) {
			new DxExceptionDlg(
					"In SaveAsTxtDlg.inNewFile: " + ose.getMessage(), ose);
		} catch (Exception e) {
			new DxExceptionDlg("In SaveAsTxtDlg.inNewFile: " + e.getMessage(),
					e);
		}
	}
	 ...
	 */
	/*
	 * private String saveReport(String currentFile, String data){ String error =
	 * ""; try{ FileWriter fw = new FileWriter(currentFile); fw.write(data);
	 * fw.close(); return error; } catch(Exception e){ error = "Problem with the
	 * file"; new FatalProblemDlg(error); return error; } }// saveReport
	 */
