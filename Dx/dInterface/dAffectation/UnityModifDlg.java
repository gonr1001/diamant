...
//    initDialog();
//  }
  public UnityModifDlg(Dialog parent, DModel dModel,String title,DResource section) {
	    super(parent,dModel,title+section.getID()+".", DConst.NUMBER_OF_UNITIES, 1);//    "Nombre d'blocs",1);
	    _title=title+section.getID()+".";
	    _section= (Section)section.getAttach();
	    init();
	    _buttonsPanel = DxTools.buttonsPanel(this, _buttonsNames);
