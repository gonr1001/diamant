...
\begin{itemize}
    \item \pro{dInternal/DataExange}
    \item \pro{dInternal/DModelProcess}
    \item \pro{dInternal/DObject}
    \item \pro{dInternal/DResource}
    \item \pro{dInternal/DSetOfResources}
    \item \pro{dInternal/DSetOfStates}
    \item \pro{dInternal/DState}
    \item \pro{dInternal/DValue}
    \item \pro{dInternal/dData/ByteArrayMessage}
    \item \pro{dInternal/dData/DSaveData}
    \item \pro{dInternal/dData/DStandardReportData}
    \item \pro{dInternal/dData/StandardCollection}
...
\begin{itemize}
    \item Activités (aucun)
    \item Groupes (indiquer le site)
    \item Enseignant (aucune)
