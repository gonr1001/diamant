...
1 & \mbox{si l'examen}~i~\mbox{est associé à une période de temps}~t \\
0 &  \mbox{sinon} \\
\end{array} \right.
\]
...
\[
\begin{array}{l}
e_{i,i'}~ \mbox{le nombre d'étudiants qui prenennt l'examen numéro}~i~\mbox{et l'examen numéro}~i'~\mbox{en même temps}\\
\end{array}
\]
