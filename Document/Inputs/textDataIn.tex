...
Le fichier de locaux est produit localement par l'utilisateur. Tous les fichiers
ont un format très rigide. Le nombre de caractères et
...
\begin{itemize}
     ...
     \item L'instance du programme que l'étudiant suit correspond aux deux chiffres suivants.
...
Les détails de la ligne de type 3.Elle contient la liste des activités suivies par
...
\pro{eMatricule} correspond aux indices 0 à 7 de la ligne de type deux. Il est mis dans \verb!_resourceKey!.

\pro{eNom} correspond aux indices 21 à 29 de la ligne de type deux. Il est mis dans \verb!_resourceID!.

\pro{eAux} correspond aux indices 0 à 20 de la ligne de type deux. Il est mis dans \verb!_auxField!.

\pro{eSelectedCourses} correspond aux cours dans la ligne de type trois. Il est mis dans \verb!_DXObject!.
