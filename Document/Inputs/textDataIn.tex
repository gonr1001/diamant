...
\item Ensuite il y a $n$ couples de lignes allant du type 2 au type 13.
    \begin{enumerate}
    \item La ligne de type 2 est une chaîne de caractères correspondant au sigle du cours (\verb!ADM1111 A!. Ceci décrit la leçon magistrale du cours \verb!ADM111! avec le groupe \verb!A!).
    \item La ligne de type 3 décrit l'état du cours, c'est une valeur entière (0 si le cours est inactif et 1 dans l'autre cas). 
    ...
    \item La ligne de type 6
    \item La ligne de type 7
    \item La ligne de type 8
    \item La ligne de type 9
    \item La ligne de type 10
    \item La ligne de type 11
    \item La ligne de type 12
    \item La ligne de type 13
    \end{enumerate}
\end{enumerate}
