...
Le cinquième type du fichier $.dia$  contient des informations concernant les cours offerts à une session. Nous y retrouvons la liste des activités associées, l'agencement du cours, le nom de l'enseignant qui le donnera, etc.
...
\begin{enumerate}
    ...
    \item Le nom de l'enseignant du cours. Si l'activité a plus d'un bloc, il y'aura autant d'enseignants qu'il y'aura de blocs et les noms des enseignants seront séparés par des «~;~»;
