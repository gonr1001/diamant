...
\begin{itemize}
    ...
    \item Niveau 2: il correspond à l'ensemble des cycles de la grille horaire. Chaque éléments du niveau 2 (un cycle) est constitué de plusieurs éléments de niveau 3.\\

    \item Niveau 3: il correspond à l'ensemble des jours d'un cycle. Chaque éléments du niveau 3 (une journée) est constitué de plusieurs éléments de niveau 4.\\

    \item Niveau 4: il correspond à l'ensemble des séquences d'une journée. chaque éléments du niveau 4 (une séquence) est constitué de plusieurs éléments de niveau 5.\\
...
\begin{figure}[h]
  % Requires \usepackage{graphicx}
  \begin{center}
    \includegraphics[height=5.0in,angle=-90]{Images/organigramme.eps}
