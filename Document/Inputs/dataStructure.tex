...
Le noeud principal de la structure de données de \diamant{} est représenté par la classe \emph{LoadData} (voir figure \ref{datastruct}). Cette classe contient la liste des différentes ressources, à savoir:
