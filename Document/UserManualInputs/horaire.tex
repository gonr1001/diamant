...
À partir de cette étape, la construction de l'horaire à proprement parler peut commencer. Lancer l'\textbf{\emph{Affectation initiale}} à partir du menu \textbf{\emph{Optimisation}} avant de passer à la phase 2. Elle exécutera les fonctionnalités suivantes:
