...
Le rapport complet permet de visualiser les événements placés dans la grille horaire (voir figure ). 

\begin{figure}[h]
% Requires \usepackage{graphicx}
    \begin{center}
        \includegraphics[width=4.0in]{UserManualInputs/images/rap_full.eps}
        \caption{Rapport complet}\label{rap_fulle}
    \end{center}
\end{figure}
    
Les informations fournies pour chaque événement peuvent être de 