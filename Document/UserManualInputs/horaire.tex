...
de la Faculté)~: \verb!cours.sig!, \verb!choixet.sig!,
\verb!disprof.sig! et \verb!locaux.txt!. Ces fichiers peuvent
...
Exemple: choisissez le nom de fichier \verb!E02cours! pour Été 2002 horaire de cours et le fichier créé sera \verb!E02cours.dim!. L'extension \verb!.dim! est rajouté automatiquement.
...
À partir de la fenêtre \emph{liste des événements}, vous pouvez sélectionner un ou plusieurs événements et les faire passer de la colonne \emph{figés} (les événements sont placées et figées dans la grille horaire) à \emph{placés} (les événements sont placées dans la grille horaire) ou de la colonne \emph{placés} à \emph{non placés} (les événements ne sont pas encore placées dans la grille horaire).
...
\subsubsection{OUVERTURE ET SAUVEGARDE D'UN HORAIRE}
...
Pour ouvrir un horaire, lancer le menu \textbf{\emph{Fichier}} \Rar \textbf{\emph{Ouvrir horaire ...}} pour voir apparaître la fenêtre de la figure \ref{opentte}. Parcourir le disque pour trouver l'emplacement du fichier d'horaire (avec l'extension \verb!.dia!) à ouvrir. Sélectionner le fichier et cliquer sur le bouton \textbf{\emph{Ouvrir}} ou double-cliquer simplement sur le fichier pour l'ouvrir.
...
% Requires \usepackage{graphicx}
    \begin{center}
        \includegraphics[width=2.0in]{UserManualInputs/images/opentt.eps}
        \caption{Ouverture d'un horaire}\label{opentte}
    \end{center}
\end{figure}

\subsubsection{Sauvegarde d'un horaire}

Pour sauvegarder un horaire, lancer le menu \textbf{\emph{Fichier}} \Rar \textbf{\emph{Enregistrer ...}} ou \textbf{\emph{Fichier}} \Rar \textbf{\emph{Enregistrer sous ...}} pour voir apparaître la fenêtre de la figure \ref{savette}. Parcourir le disque pour trouver où enregistrer l'horaire. Entrer le nom a attribuer à l'horaire (avec ou sans extension \verb!.dia!) et cliquer sur le bouton \textbf{\emph{Enregistrer}}.

\begin{figure}[h]
% Requires \usepackage{graphicx}
    \begin{center}
        \includegraphics[width=2.0in]{UserManualInputs/images/savett.eps}
        \caption{Sauvegarde d'un horaire}\label{savette}
    \end{center}
\end{figure}
