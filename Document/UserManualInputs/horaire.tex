...
À partir de cette étape, la construction de l'horaire à proprement parler peut commencer. Il est vivement recommandé de lancer l'\textbf{\emph{affection initiale}} à partir du menu \textbf{\emph{Optimisation}} avant de poursuivre la production de l'horaire. 

La construction de l'horaire peut être découpée en deux étapes, la première permettant de modifier et épurer les données et la seconde permettant de faire une affectation initiale et d'optimiser les placements. 
...
Il est vivement recommandé de commencer cette étape en lançant l'\textbf{\emph{affection initiale}} à partir du menu \textbf{\emph{Optimisation}} (si cela n'a pas été précédemment fait à la fin de la phase de préparation de l'horaire - section \ref{finprepa}) avant de poursuivre la production de l'horaire.

\subsubsection{Description du fonctionnement de l'\emph{affectation initiale}}
