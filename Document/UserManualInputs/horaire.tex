...
\begin{enumerate}
    \item Suppression des activités de nature 2, seulement les activités de nature 1 seront conservées pour l'horaire.
...
\begin{itemize}
    \item \emph{Max Conflits Étu entre 2 Eve}: ce paramètre permet de fixer le nombre maximal de conflits d'étudiants admissible entre deux événements.
    \item \emph{Max Conflits Ens entre 2 Eve}: ce paramètre permet de fixer le nombre maximal de conflits d'enseignants admissible entre deux événements.
    \item \emph{Max Conflits Loc entre 2 Eve}: ce paramètre permet de fixer le nombre maximal de conflits de locaux admissible entre deux événements.
...
Le raffinement de l'horaire propose à travers certains outils (affectation manuelle, rapport), les voies et moyens d'amélioration de l'horaire construit.
...
L'affectation manuelle permet à l'utilisateur de placer individuellement les événements dans la grille horaire. Elle se fait à partir de la fenêtre d'\textbf{\emph{Affection manuelle}} (voir figure \ref{man}) obtenue à partir du sous-menu \textbf{\emph{Affectation manuelle}} du menu \textbf{\emph{Affectation}}.
    ...
    \begin{figure}[h]
      ...
      \begin{center}
        ...
        \caption{Liste des événements}\label{man}
      \end{center}
    \end{figure}
