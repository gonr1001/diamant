...
\begin{itemize}
    ...
    \item Phase 4: elle concerne l'utilisation d'outils permettant de raffiner
    l'horaire (ouverture et sauvegarde d'un horaire, affectation manuelle, rapports, etc.);
...
nécessaire de sauvegarder l'horaire et de continuer plus tard le
travail, ou faire des affectations manuelles à l'horaire, ou
encore visualiser les rapports phase 4.
...
Toutefois, les options du logiciel ne seront pas toutes présentées.
...
Cette étape consiste à lancer le sous menu \textbf{\emph{Construire l'horaire}} à partir du menu \textbf{\emph{Optimisation}}, afin de laisser le logiciel placer automatiquement dans la grille horaire les événements (ceux qui n'ont pas encore été placés dans la grille horaire) respectant toutes les contraintes spécifiées et ne créant aucun nouveau conflit (conflits d'enseignants, conflits d'étudiants et conflits de locaux).
