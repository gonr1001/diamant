...
Le modèle de \dx{} est bâti autour de quatre principaux sous-composants: le sous-composant \verb!model!, le sous-composant \verb!data!, le sous-composant \verb!ttstructure! et le sous-composant \verb!optimization!.
...
\subsubsection{Description du sous-composant \verb!model!}

Le sous-composant \verb!model! représente le point d'entrée du composant modèle (de l'architecture MVC), il est l'interface à travers laquelle le modèle communique avec les autres composants que sont la vue et le contrôleur.
