...
\subsection{Configuration du compilateur}
    ...
    \item Ouvrir \emph{\textbf{Errors/Warnings}} et vérifier les options suivantes
        ...
        \item Using deprecated API
            ...
            \\
            Signal overridding or implementing deprecated methods & /
            \\
            \hline
            \end{tabular}$
...
\begin{enumerate}
    ...
    \item Sélectionner \textbf{\emph{Add}}
    \item choisir le repertoire \textbf{D:/Programs Files/Local/texmf-local}
