...
public abstract class DSetOfResources extends DObject {
	...
	// XXXX Pascal: Pkoi pas une Hash au lieu de Vecteur? Il semble que
	// quelqu'un a essaye d'implementer
	// un hash en utiliant un Vector (deprecated en passant) comme contenant.
	// C'est tres bizzare.
	private Vector<DResource> _resourceList;

	/**
	 * give type of the last sort _stateSort 0= sortSetOfResourcesByKey; 1=
	 * sortSetOfResourcesByID; 2= sortSetOfResourcesBySelectedField
	 */
	int _stateSort = 0;
	...
	/**
	 * Constructor 0= activities, 1= students, 2= instructors, 3 = rooms, 4=
	 * ttstructure 5= states, 6 = events
	 * 
	 * @param int
	...
	public DSetOfResources() {
		...
		_resourceList = new Vector<DResource>(1, 1); // XXXX Pascal: Pourquoi
														// (1,1) ? Quel est la
														// motivation?
	 ...
	 *            a Resource object
	 * @param insertType
	 *            an integer. it select the type of insert you want to do
	 *            insertType=0 (insert by using key); insertType=1 (insert by
	 *            using ID)
	 * @return boolean (true if Resource added to list, false if Resource not
	 *         added because it already exists)
	 */
	// XXXX Pascal: cette methode a un comportement X si insertType vaut 0 et Y
	// si insertType vaut 1?
	// Ouch! Pourquoi pas deux methodes distinctes? On peut utiliser une methode
	// privee pour le
...
//	}
	 ...
	 * 
	 * @param Vector
	 *            the vector of resource list to set
	 */
	 ...
	 * 
	 * @param IDs
	 *            Array containing the IDs of the resources to be setted
	 * @param fieldIndex
	 *            The index of the value to be setted
	 * @param value
	 ...
	 * 
	 * @param int
	 *            the position of the resource in the resourcelist
	 ...
	 * 
	 * @param long
	 *            integer, the key of the Resource
...
//	}
	 ...
	 * 
	 * @param orderIndex
	 *            The order of elements arrangement. If sortIndex == 0 then the
	 *            set of resources is sorted by the resource key. If sortIndex ==
	 *            1 then the set of resources is sorted by the resource ID.
	 * @return
	 */
	...
	/**
	 * Creates a Vector containig the IDs of the resources whose the value of
	 * the field (defined by the argument "fieldIndex") is equals to value
	 * defined by the argument "fieldValue". The fieldIndex is defined in each
	 * resource. The value may be a String, or the string representation of an
	 * int or a boolean.
	 * 
	 * @param fieldIndex
	 *            The identification index of a field belonging the resource
	 * @param fieldValue
	...
	/**
	 * @param setOflements
	 *            the elements in wich we want to change value
	 * @param fieldIndex
	 *            The identification index of a field belonging the resource
	 * @param fieldValue
	 *            The comparaison value for the field selected
	...
	// * @param integer 0= sort by key; 1= sort by ID, 2= sort by selected
	// object field
	// * @param integer if there's sort by selected object field it represent
	// the
	 ...
	 * 
	 * @param long
	 *            the DResource key from wich to find index in SetOfResources
	 ...
	 * 
	 * @param String
	 *            the DResource ID from wich to find index in SetOfResources
	 * @return int index of the DResource in SetOfResources
	 */
	 ...
	 *            the specified SetOfResources
	 * @return bolean true if this SetOfResources and the specified
	 *         SetOfResources are equals false if they are not equals
	 */
