...
//	/**
//	 * test_analyseTokensFirstVersion, detects the empty activity name
//	 * in the activities file
//	 * */
//	public void test_analyseTokensFirstVersion() {
//		StringBuffer sbTokens = new StringBuffer();
//		sbTokens.append("");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("1");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("1");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("LUC LAJOIE");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("1");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("3");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("1 12");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("1");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("C1-387");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("0");
//		sbTokens.append(DConst.CR_LF);
//		sbTokens.append("0");
...
////				+ "\r\n" + "0" + "\r\n" + "0" + "\r\n" + "0" + "\r\n";
//
//		SetOfActivitiesInSites setOfActivitiesInSites = new SetOfActivitiesInSites(false,
//				60);
//		DxLoadData ld = new DxLoadData();
//		
//
//		try {
//			System.out.println("Tokens :"+ sbTokens.toString());
//			setOfActivitiesInSites.analyseTokens(ld.insertHeader(sbTokens.toString().getBytes()),
//				1);
//		}
//		catch (DiaException e) {
//			System.out.println(e.getMessage());
//			assertEquals("test_analyseTokensFirstVersion: ",
...
//	}
	 ...
	 * in the activities file
	 * */
	public void test_analyseTokens1dot6() {
		StringBuffer sbTokens = new StringBuffer();
		sbTokens.append(DConst.FILE_VER_NAME1_6);
		sbTokens.append(DConst.CR_LF);
		sbTokens.append("1");
		sbTokens.append(DConst.CR_LF);
		sbTokens.append("1");
...
//		String tokens = "";
//		try {
//			tokens = new String(dataPreLoad(_pathForFiles + "cours1.sig" ));
//		} catch (DiaException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
//		SetOfActivitiesInSites setOfActivities = new SetOfActivitiesInSites(false,
//				60);
//		DxLoadData ld = new DxLoadData();
...
//		String tokens = "";
//		try {
//			tokens = new String(dataPreLoad(_pathForFiles + "cours2.sig" ));
//		} catch (DiaException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
...
//				setOfActivities.getError().substring(0,
//						DConst.ACTI_TEXT5.length()));
//		assertEquals("test4_analyseTokens: assertEquals 2", 23, setOfActivities
//				.getLine());
//
//	}
//
...
//				+ "0 0" + "\r\n";
//
//		SetOfActivitiesInSites setOfActivitiesSites = new SetOfActivitiesInSites(
//				false, 60);
//		DxLoadData ld = new DxLoadData();
//		setOfActivitiesSites.analyseTokens(ld.buildDataExchange(tokens
//				.getBytes()), 1);
//		if (setOfActivitiesSites.getError().length() == 0) {
//			setOfActivitiesSites.buildSetOfResources(ld
//					.buildDataExchange(tokens.getBytes()), 1);
//		}
//		SetOfActivities setOfActivities = (SetOfActivities) setOfActivitiesSites
//				.getResource("SHE").getAttach();
//		assertEquals("test0_addActivity: assertEquals 0", 2, setOfActivities
//				.size());
//		DResource activityResc = setOfActivities.getResource("ADM111");
//		assertEquals("test1_addActivity: assertEquals 1", 1, activityResc
//				.getKey());
//		assertEquals("test2_addActivity: assertEquals 2", 2,
...
//		assertEquals("test3_addActivity: assertEquals 3", 2, ((Type) typeResc
//				.getAttach()).getSetOfSections().size());
//	}
//
//	/**
//	 * test_addActivity, test that all elements of the activity are added
...
//		SetOfActivities setOfActivities = (SetOfActivities) setOfActivitiesSites
//				.getResource("SHE").getAttach();
//		assertEquals("test0_addActivitDiffRooms: assertEquals 0", 2,
//				setOfActivities.size());
//		DResource activityResc = setOfActivities.getResource("GEI441");
//		assertEquals("test1_addActivitDiffRooms: assertEquals 1", 2,
//				activityResc.getKey());
//		assertEquals("test2_addActivitDiffRooms: assertEquals 2", 1,
//				((Activity) activityResc.getAttach()).getSetOfTypes().size());
//		DResource typeResc = ((Activity) activityResc.getAttach())
//				.getSetOfTypes().getResource("1");
//		assertEquals("test3_addActivitDiffRooms: assertEquals 3", 1,
//				((Type) typeResc.getAttach()).getSetOfSections().size());
//		DResource sectionResc = ((Type) typeResc.getAttach())
//				.getSetOfSections().getResource(1);
//		assertEquals("test4_addActivitDiffRooms: assertEquals 4", 2,
//				((Section) sectionResc.getAttach()).getSetOfUnities().size());
//		DResource unitResc1 = ((Section) sectionResc.getAttach())
//				.getSetOfUnities().getResource(1);
//		assertEquals("test5_addActivitDiffRooms: assertEquals 5", 1,
//				((Unity) unitResc1.getAttach()).getSetOfAssignments().size());
//		DResource unitResc2 = ((Section) sectionResc.getAttach())
//				.getSetOfUnities().getResource(2);
//		assertEquals("test6_addActivitDiffRooms: assertEquals 6", 1,
//				((Unity) unitResc2.getAttach()).getSetOfAssignments().size());
//		DResource assignRes1 = ((Unity) unitResc1.getAttach())
//				.getSetOfAssignments().getResource(1);// Unity)unityResource.getAttach();
//		assertEquals("test7_addActivitDiffRooms: assertEquals 7", "C1-387",
//				((Assignment) assignRes1.getAttach()).getRoomName());
//		DResource assignRes2 = ((Unity) unitResc2.getAttach())
//				.getSetOfAssignments().getResource(1);// Unity)unityResource.getAttach();
//		assertEquals("test8_addActivitDiffRooms: assertEquals 8", "xxxxx",
//				((Assignment) assignRes2.getAttach()).getRoomName());
//	}
//
//	/**
...
//				+ "0" + "\r\n" + "0 ; 0" + "\r\n";
//
//		SetOfActivitiesInSites setOfActivities = new SetOfActivitiesInSites(true,
//				60);
//		DxLoadData ld = new DxLoadData();
//		setOfActivities.analyseTokens(ld.buildDataExchange(tokens.getBytes()),
//				1);
...
//				DConst.ACTI_TEXT13, setOfActivities.getError().substring(0,
//						DConst.ACTI_TEXT13.length()));
//	}
//
//	private byte[] dataPreLoad(String str) throws DiaException {
