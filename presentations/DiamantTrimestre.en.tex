% $Header: /grp/cvs/cvstictac/DiamantExtremeCopy/presentations/DiamantTrimestre.en.tex,v 1.2 2005-07-05 12:04:41 gonzrubi Exp $
...
\pgfdeclareimage[height=0.25cm]{university-logo}{udslogo}
...
\begin{frame}
  \frametitle{Entrée d'information}
  ...
  \item Registraire.
    ...
    \item Facultés.
       \pause
        \begin{itemize}
            \item Offre d'AP, données de l'horaire.
        \pause
        \end{itemize}
    \item Diamant.
        \pause
        \begin{itemize}
            \item Aide à construire l'horaire.
        \pause
        \end{itemize}
   \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{L'évolution des données pendant la production d'un
horaire}
...
\put(30, 5){\makebox(20,10){D. période $P$}}
...
\begin{frame}
  ...
  \item Registraire.
    \pause
    \begin{itemize}
        \item Étudiants. Rien à changer. Étudiant inscrit à AP.
        \pause
        \end{itemize}
    \item Facultés.
       \pause
        \begin{itemize}
            \item Offre d'AP, données de l'horaire. Correspondance
            entre AP et APP. Événements dans un APP. Équipes ou-et
            groupes? Grille horaire (déjà fait). Reservation de
            locaux.
        \pause
        \end{itemize}
    \item Diamant.
        \pause
        \begin{itemize}
            \item Aide à construire l'horaire. Mêmes modifications
            que sur les données. Plus unification finale?
        \pause
        \end{itemize}
   \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Réunion Faculté de génie}
  \framesubtitle{Sources}
  % - A title should summarize the slide in an understandable fashion
  %   for anyone how does not follow everything on the slide itself.
  ...
  \item Génie mécanique.
    \pause
    \begin{itemize}
        \item Horaire dynamique (100\% sûr pour deux semaines).
        \pause
...
\begin{frame}
  ...
  \begin{itemize}
  \item
    Résumé de discussions + actions.
  \item
    Validations. Unifier avec Faculté médecine.
  \item
    Planification du projet. Unifier avec Faculté médecine.
  \end{itemize}
